...
insert into "metalake_demo.catalog_hive".sales.stores (store_id, store_name, location) values
...
(10,'Akron store','Ohio');
insert into "metalake_demo.catalog_hive".sales.categories (category_id, category_name) values
(1,'Bakeware'),(2,'Coffee & Tea'),(3,'Candles'),(4,'Cookware'),(5,'Dinnerware'),
(6,'Glassware'),(7,'Kitchenware'),(8,'Knives'),(9,'Tableware'),(10,'Outdoor');
insert into "metalake_demo.catalog_hive".sales.products (product_id, category_id, product_name, price) values
...
insert into "metalake_demo.catalog_hive".sales.sales (sale_id, employee_id, customer_id, product_id, store_id, sold, quantity, total_amount) values
