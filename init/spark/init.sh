...
cp /tmp/spark/packages/gravitino-spark-connector-runtime-3.4_2.12-0.9.0-incubating.jar /opt/spark/jars/gravitino-spark-connector-runtime-3.4_2.12-0.9.0-incubating.jar
